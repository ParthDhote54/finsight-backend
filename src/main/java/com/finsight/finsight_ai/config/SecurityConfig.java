...
public class SecurityConfig {
    ...
    @Value("${finsight.frontend.origin:http://localhost:5173}")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Environment-configurable allowed origin (defaults to local Vite dev server)
        String originPattern = (allowedFrontendOrigin != null && !allowedFrontendOrigin.isBlank())
